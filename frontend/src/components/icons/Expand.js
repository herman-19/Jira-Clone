...
const Expand = ({expandIssue}) => {
    return (
        <div className='top-modal-button' onClick={expandIssue}>
            <svg xmlns='http://www.w3.org/2000/svg' style={{ margin: '0px 12px' }} width='22' height='22' fill='currentColor' className='bi bi-arrows-angle-expand' viewBox='0 0 18 18'>
